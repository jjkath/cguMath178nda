...
\begin{center}
  \begin{tabular}{p{\textwidth}} %p{12cm}
  \toprule[.5mm]
  \textbf{Algorithm 1} Smoothing estimates of the orientation using optimization \tabularnewline
  \midrule[.25mm]
  \textsc{Hello World} \tabularnewline
  \bottomrule[.5mm]
  \end{tabular}
\end{center}
